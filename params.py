...
def get_parser():
    ...
    parser.add_argument('--test_path', default='./data/cattolica2022_labelled/images/vine_cvat_subset_rotated_split',
    ...
    parser.add_argument('--out_dir', default='../data/RGB_MaskRCNN_SFT_cat22_output_',
